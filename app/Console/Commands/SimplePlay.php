...
class SimplePlay extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:simple-play';
    ...
    {
        $inputFilePath = base_path('app/Console/Commands/json_data/SimplePlay.json');
        $outputFilePath = base_path('app/Console/Commands/data/SimplePlayModify.json');
