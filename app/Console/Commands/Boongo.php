...
class Boongo extends Command
{
     ...
     * @var string
     */
    protected $signature = 'app:boongo';
    ...
    {
        $inputFilePath = base_path('app/Console/Commands/json_data/Boongo.json');
        $outputFilePath = base_path('app/Console/Commands/data/BoongoModify.json');
