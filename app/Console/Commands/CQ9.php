...
class CQ9 extends Command
{
    ...
    public function handle()
    {
        ...
        $inputFilePath = base_path('app/Console/Commands/json_data/CQ9.json');
        $outputFilePath = base_path('app/Console/Commands/data/CQ9Modify.json');
