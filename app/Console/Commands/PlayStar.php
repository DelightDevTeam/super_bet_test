...
class PlayStar extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:play-star';
    ...
    public function handle()
    {
        ...
        $inputFilePath = base_path('app/Console/Commands/json_data/PlayStar.json');
        $outputFilePath = base_path('app/Console/Commands/data/PlayStarModify.json');
