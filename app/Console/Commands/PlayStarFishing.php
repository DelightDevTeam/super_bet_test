...
class PlayStarFishing extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:play-star-fishing';
    ...
    public function handle()
    {
        ...
        $inputFilePath = base_path('app/Console/Commands/json_data/PlayStarFishing.json');
        $outputFilePath = base_path('app/Console/Commands/data/PlayStarFishingModify.json');
