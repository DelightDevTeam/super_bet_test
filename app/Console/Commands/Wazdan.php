...
class Wazdan extends Command
{
     ...
     * @var string
     */
    protected $signature = 'app:wazdan';
    ...
    {
        $inputFilePath = base_path('app/Console/Commands/json_data/Wazdan.json');
        $outputFilePath = base_path('app/Console/Commands/data/WazdanModify.json');
