...
class GENESIS extends Command
{
     ...
     * @var string
     */
    protected $signature = 'app:g-e-n-e-s-i-s';
    ...
    {
        $inputFilePath = base_path('app/Console/Commands/json_data/GENESIS.json');
        $outputFilePath = base_path('app/Console/Commands/data/GENESISModify.json');
