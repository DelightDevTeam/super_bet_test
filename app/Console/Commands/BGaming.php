...
class BGaming extends Command
{
     ...
     * @var string
     */
    protected $signature = 'app:b-gaming';
    ...
    public function handle()
    {
        ...
        $inputFilePath = base_path('app/Console/Commands/json_data/BGaming.json');
        $outputFilePath = base_path('app/Console/Commands/data/BGamingModify.json');
