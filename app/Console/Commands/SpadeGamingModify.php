...
class SpadeGamingModify extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:spade-gaming-modify';
    ...
    public function handle()
    {
        ...
        $inputFilePath = base_path('app/Console/Commands/json_data/SpadeGaming.json');
        $outputFilePath = base_path('app/Console/Commands/data/ModifySpadeGaming.json');
