...
class NetGame extends Command
{
     ...
     * @var string
     */
    protected $signature = 'app:net-game';
    ...
    {
        $inputFilePath = base_path('app/Console/Commands/json_data/NetGame.json');
        $outputFilePath = base_path('app/Console/Commands/data/NetGameModify.json');
