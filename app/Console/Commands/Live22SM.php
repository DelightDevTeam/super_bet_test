...
class Live22SM extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:live22-s-m';
    ...
    {
        $inputFilePath = base_path('app/Console/Commands/json_data/Live22SM.json');
        $outputFilePath = base_path('app/Console/Commands/data/Live22SMModify.json');
