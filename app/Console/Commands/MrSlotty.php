...
class MrSlotty extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:mr-slotty';
    ...
    public function handle()
    {
        ...
        $inputFilePath = base_path('app/Console/Commands/json_data/MrSlotty.json');
        $outputFilePath = base_path('app/Console/Commands/data/MrSlottyModify.json');
