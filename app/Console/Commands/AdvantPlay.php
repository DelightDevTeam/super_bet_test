...
class AdvantPlay extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:advant-play';
    ...
    {
        $inputFilePath = base_path('app/Console/Commands/json_data/AdvantPlay.json');
        $outputFilePath = base_path('app/Console/Commands/data/AdvantPlayModify.json');
