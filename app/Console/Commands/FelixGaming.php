...
class FelixGaming extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:felix-gaming';
    ...
    {
        $inputFilePath = base_path('app/Console/Commands/json_data/FelixGaming.json');
        $outputFilePath = base_path('app/Console/Commands/data/FelixGamingModify.json');
