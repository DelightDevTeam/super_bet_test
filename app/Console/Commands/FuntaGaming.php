...
class FuntaGaming extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:funta-gaming';
    ...
    {
        $inputFilePath = base_path('app/Console/Commands/json_data/FuntaGaming.json');
        $outputFilePath = base_path('app/Console/Commands/data/FuntaGamingModify.json');
