...
class Netent extends Command
{
     ...
     * @var string
     */
    protected $signature = 'app:netent';
    ...
    {
        $inputFilePath = base_path('app/Console/Commands/json_data/Netent.json');
        $outputFilePath = base_path('app/Console/Commands/data/NetentModify.json');
