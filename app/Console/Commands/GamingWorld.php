...
class GamingWorld extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:gaming-world';
    ...
    {
        $inputFilePath = base_path('app/Console/Commands/json_data/GamingWorld.json');
        $outputFilePath = base_path('app/Console/Commands/data/GamingWorldModify.json');
