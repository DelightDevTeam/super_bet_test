...
class Habanero extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:habanero';
    ...
    public function handle()
    {
        ...
        $inputFilePath = base_path('app/Console/Commands/json_data/Habanero.json');
        $outputFilePath = base_path('app/Console/Commands/data/HabaneroModify.json');
