...
class ZeusPlay extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:zeus-play';
    ...
    {
        $inputFilePath = base_path('app/Console/Commands/json_data/ZeusPlay.json');
        $outputFilePath = base_path('app/Console/Commands/data/ZeusPlayModify.json');
