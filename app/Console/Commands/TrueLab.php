...
class TrueLab extends Command
{
     ...
     * @var string
     */
    protected $signature = 'app:true-lab';
    ...
    public function handle()
    {
        ...
        $inputFilePath = base_path('app/Console/Commands/json_data/TrueLab.json');
        $outputFilePath = base_path('app/Console/Commands/data/TrueLabModify.json');
