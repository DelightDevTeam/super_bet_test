...
class SkywindCasino extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:skywind-casino';
    ...
    {
        $inputFilePath = base_path('app/Console/Commands/json_data/SkywindCasino.json');
        $outputFilePath = base_path('app/Console/Commands/data/SkywindCasinoModify.json');
