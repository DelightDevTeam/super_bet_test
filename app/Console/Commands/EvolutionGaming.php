...
class EvolutionGaming extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:evolution-gaming';
    ...
    {
        $inputFilePath = base_path('app/Console/Commands/json_data/EvolutionGaming.json');
        $outputFilePath = base_path('app/Console/Commands/data/EvolutionGamingModify.json');
