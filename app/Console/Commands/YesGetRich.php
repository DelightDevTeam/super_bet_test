...
class YesGetRich extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:yes-get-rich';
    ...
    {
        $inputFilePath = base_path('app/Console/Commands/json_data/YesGetRich.json');
        $outputFilePath = base_path('app/Console/Commands/data/YesGetRichModify.json');
