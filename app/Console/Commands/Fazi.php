...
class Fazi extends Command
{
    ...
    {
        $inputFilePath = base_path('app/Console/Commands/json_data/Fazi.json');
        $outputFilePath = base_path('app/Console/Commands/data/FaZiModify.json');
