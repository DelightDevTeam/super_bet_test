...
class SpadeGamingFishing extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:spade-gaming-fishing';
    ...
    public function handle()
    {
        ...
        $inputFilePath = base_path('app/Console/Commands/json_data/SpadeGamingFishing.json');
        $outputFilePath = base_path('app/Console/Commands/data/ModifySpadeGamingFishing.json');
