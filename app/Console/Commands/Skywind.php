...
class Skywind extends Command
{
     ...
     * @var string
     */
    protected $signature = 'app:skywind';
    ...
    {
        $inputFilePath = base_path('app/Console/Commands/json_data/Skywind.json');
        $outputFilePath = base_path('app/Console/Commands/data/SkywindModify.json');
